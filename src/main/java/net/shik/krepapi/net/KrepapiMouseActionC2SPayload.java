...
public record KrepapiMouseActionC2SPayload(ProtocolMessages.MouseActionEvent action) implements CustomPayload {
    public static final CustomPayload.Id<KrepapiMouseActionC2SPayload> ID = CustomPayload.id(KrepapiChannels.C2S_MOUSE_ACTION);

    public static final PacketCodec<RegistryByteBuf, KrepapiMouseActionC2SPayload> CODEC = PacketCodec.ofStatic(
            (buf, payload) -> {
